function [porkChop_data] = porkChopDatav2(p1,p2,dep,arr,theta_arr_constraint)



thetac1 = theta_arr_constraint(1);
thetac2 = theta_arr_constraint(2);
...
for i=1:length(dep)
	for j=1:length(arr)
		...
		if dep_date<arr_date
            ...
            if kep_p2(6)<thetac1 || kep_p2(6)>thetac2
                dv1(i,j)=NaN;
                dv2(i,j)=NaN;
                TOF(i,j)=NaN;
            else                
